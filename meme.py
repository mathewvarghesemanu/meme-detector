...
mypath="C:\\Users\\MATHE\\Desktop\\pixel4\\memes"
new_path="C:\\Users\\MATHE\\Desktop\\pixel4\\meme50"
...
model = torch.hub.load('ultralytics/yolov5', 'custom', path="C:\\Users\\MATHE\\Desktop\\meme-detection\\yolov5\\text2.pt"    , force_reload=True)
model.eval()
...
for file_path in onlyfiles:
    ...
    try:
        for i in range(20):
            ...
            if text_area/image_area>text_area_thres:
